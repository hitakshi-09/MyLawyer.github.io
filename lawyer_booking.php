									...
									<div class="widget-content">
										...
										<table class="table table-striped table-bordered  table-success table-responsive">
											...
											<?php
												...
												$conn = connect();
												$result = mysqli_query($conn,"SELECT booking_id,first_Name,last_Name,date,description,email,booking.status as 'statuss' FROM booking,client,user WHERE booking.client_id=client.client_id AND client.client_id=user.u_id and booking.lawyer_id='$a'");
												$counter = 0;
